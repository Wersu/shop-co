    ...
    <div className="flex flex-col content-center">
      <div className="flex items-center justify-between py-6">
        ...
        <div className="flex items-center gap-[10px]">
          <button className="rounded-full bg-[#F0F0F0] px-3 py-3">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <button className="flex items-center gap-[21px] rounded-full bg-[#F0F0F0] px-[20px] py-3">
            Latest
            <svg
              width="12"
              height="7"
