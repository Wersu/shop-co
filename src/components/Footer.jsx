    ...
    <>
      ...
      <footer className="bg-[#F0F0F0] pt-44 lg:pt-36">
        <div className="container mx-auto px-2 2xl:max-w-7xl">
          <div className="flex flex-col gap-9 border-b border-black/10 pb-13 lg:flex-row">
            <div className="flex flex-col lg:max-w-[248px]">
              ...
              <div className="mt-auto flex gap-3">
                <a
                  href="#!"
                  className="flex h-7 w-7 items-center justify-center rounded-full border-1 border-black/20 bg-white hover:border-black hover:bg-black hover:text-white"
                >
                  <svg
                    width="12"
                    height="10"
            ...
            <div className="grid grid-cols-2 gap-6 max-[340px]:grid-cols-1 max-[340px]:text-sm sm:flex sm:flex-3 sm:justify-between">
              <div className="flex flex-col">
                <h3 className="font-accent mb-4 tracking-[3px] uppercase sm:mb-[26px]">
                  Company
                </h3>
          ...
          <div className="flex flex-col items-center justify-between gap-4 pt-5 pb-21 text-sm sm:flex-row sm:gap-0">
            <p className="text-black/60">
              Shop.co © 2000-2025, All Rights Reserved
            </p>
            <div className="flex gap-3">
              <div className="flex h-[30px] w-[47px] items-center justify-center rounded-[6px] border-[0.4px] border-black/10 bg-white">
                <svg
                  width="34"
                  height="12"
                  viewBox="0 0 34 12"
